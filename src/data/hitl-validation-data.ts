...
export const sampleRecords: ValidationRecord[] = [
  ...
  },
  {
    ...
    existingValue: "$574.8B",
    suggestedValue: "$574.8B",
    attributes: [
      // Basic Data
      { name: "Company Name", extractedValue: "Amazon", currentValue: "Amazon", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }, { name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      { name: "Legal Name", extractedValue: "Amazon.com, Inc.", currentValue: "Amazon.com, Inc.", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Address", extractedValue: "410 Terry Ave N, Seattle, WA 98109", currentValue: "410 Terry Ave N, Seattle, WA 98109", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Phone Number", extractedValue: "+1 206-266-1000", currentValue: "+1 206-266-1000", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://amazon.com/contact" }] },
      { name: "Email ID", extractedValue: "ir@amazon.com", currentValue: "ir@amazon.com", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://amazon.com/contact" }] },
      { name: "Website URL", extractedValue: "amazon.com", currentValue: "amazon.com", status: "validated", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://amazon.com" }] },
      { name: "Industry / Sector", extractedValue: "E-commerce / Cloud", currentValue: "E-commerce / Cloud", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      { name: "CEO / Founder", extractedValue: "Andy Jassy / Jeff Bezos", currentValue: "Andy Jassy / Jeff Bezos", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }, { name: "LinkedIn", url: "https://linkedin.com/company/amazon" }] },
      { name: "LinkedIn URL", extractedValue: "https://linkedin.com/company/amazon", currentValue: "https://linkedin.com/company/amazon", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://linkedin.com/company/amazon" }] },
      { name: "Twitter URL", extractedValue: "https://twitter.com/amazon", currentValue: "https://twitter.com/amazon", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://twitter.com/amazon" }] },
      { name: "Registration Number", extractedValue: "2804291 (DE)", currentValue: "2804291 (DE)", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Incorporation Date", extractedValue: "May 28, 1996", currentValue: "May 28, 1996", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Company Status", extractedValue: "Active", currentValue: "Active", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Entity Type", extractedValue: "Corp", currentValue: "Corp", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Country", extractedValue: "USA", currentValue: "USA", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "LEI", extractedValue: "ZXTILKJKG63JELOEG630", currentValue: "ZXTILKJKG63JELOEG630", status: "validated", qcFlag: false, sourceRefs: [{ name: "GLEIF", url: "https://gleif.org/lei/ZXTILKJKG63JELOEG630" }] },
      { name: "SIC Code", extractedValue: "5961", currentValue: "5961", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "CIK", extractedValue: "1018724", currentValue: "1018724", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Ticker Symbol", extractedValue: "AMZN", currentValue: "AMZN", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      // Financial Data
      { name: "Revenue", extractedValue: "$574.8 B", currentValue: "$574.8 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }, { name: "FactSet", url: "https://factset.com/company/amazon" }] },
      { name: "Net Income", extractedValue: "$30.4 B", currentValue: "$30.4 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "EBITDA", extractedValue: "$85.5 B", currentValue: "$85.5 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "FactSet", url: "https://factset.com/company/amazon" }] },
      { name: "Total Assets", extractedValue: "$527.9 B", currentValue: "$527.9 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Shares Outstanding", extractedValue: "10.4 B", currentValue: "10.4 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Stock Price (Current)", extractedValue: "$233.65", currentValue: "$233.65", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      { name: "Market Capitalization", extractedValue: "$2.50 Trillion", currentValue: "$2.50 Trillion", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      { name: "Exchange Name", extractedValue: "NASDAQ (NYSE Peer)", currentValue: "NASDAQ (NYSE Peer)", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      { name: "Trading Status", extractedValue: "Active", currentValue: "Active", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      { name: "Stock Price (Close)", extractedValue: "$230.12", currentValue: "$230.12", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/amzn" }] },
      // Corporate Hierarchy
      { name: "Subsidiary Name", extractedValue: "Amazon Data Services", currentValue: "Amazon Data Services", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724" }] },
      { name: "Hierarchy Level", extractedValue: "1", currentValue: "1", status: "pending", qcFlag: false, sourceRefs: [{ name: "D&B", url: "https://dnb.com/company/amazon" }] },
      { name: "Coverage", extractedValue: "Global", currentValue: "Global", status: "pending", qcFlag: false, sourceRefs: [{ name: "D&B", url: "https://dnb.com/company/amazon" }] },
    ],
    sources: [
      { url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1018724", type: "API", snippet: "Amazon.com, Inc. (CIK: 1018724) filed its annual report 10-K reporting total revenue of $574.8 billion…", highlightedText: "total revenue of $574.8 billion" },
      { url: "https://amazon.com/about", type: "Website", snippet: "Amazon is guided by four principles: customer obsession, passion for invention, commitment to operational excellence…", highlightedText: "headquartered in Seattle, Washington" },
    ],
  },
  {
    id: "REC-10050",
    ...
    confidenceScore: 82,
    sourceList: ["SEC EDGAR", "Bloomberg", "Web Crawl"],
    lastUpdated: "2026-04-01 11:00",
    existingValue: "$713.2B",
    suggestedValue: "$713.2B",
    attributes: [
      // Basic Data
      { name: "Company Name", extractedValue: "Walmart", currentValue: "Walmart", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }, { name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      { name: "Legal Name", extractedValue: "Walmart Inc.", currentValue: "Walmart Inc.", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Address", extractedValue: "702 SW 8th St, Bentonville, AR 72716", currentValue: "702 SW 8th St, Bentonville, AR 72716", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Phone Number", extractedValue: "+1 479-273-4000", currentValue: "+1 479-273-4000", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://walmart.com/contact" }] },
      { name: "Email ID", extractedValue: "info@walmart.com", currentValue: "info@walmart.com", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://walmart.com/contact" }] },
      { name: "Website URL", extractedValue: "walmart.com", currentValue: "walmart.com", status: "validated", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://walmart.com" }] },
      { name: "Industry / Sector", extractedValue: "Retail", currentValue: "Retail", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      { name: "CEO / Founder", extractedValue: "Doug McMillon / Sam Walton", currentValue: "Doug McMillon / Sam Walton", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }, { name: "LinkedIn", url: "https://linkedin.com/company/walmart" }] },
      { name: "LinkedIn URL", extractedValue: "https://linkedin.com/company/walmart", currentValue: "https://linkedin.com/company/walmart", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://linkedin.com/company/walmart" }] },
      { name: "Twitter URL", extractedValue: "https://twitter.com/walmart", currentValue: "https://twitter.com/walmart", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://twitter.com/walmart" }] },
      { name: "Registration Number", extractedValue: "727671 (DE)", currentValue: "727671 (DE)", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Incorporation Date", extractedValue: "Oct 31, 1969", currentValue: "Oct 31, 1969", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Company Status", extractedValue: "Active", currentValue: "Active", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Entity Type", extractedValue: "Corp", currentValue: "Corp", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Country", extractedValue: "USA", currentValue: "USA", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "LEI", extractedValue: "5493006S77A69U9I0P78", currentValue: "5493006S77A69U9I0P78", status: "validated", qcFlag: false, sourceRefs: [{ name: "GLEIF", url: "https://gleif.org/lei/5493006S77A69U9I0P78" }] },
      { name: "SIC Code", extractedValue: "5331", currentValue: "5331", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "CIK", extractedValue: "104169", currentValue: "104169", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Ticker Symbol", extractedValue: "WMT", currentValue: "WMT", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      // Financial Data
      { name: "Revenue", extractedValue: "$713.2 B", currentValue: "$713.2 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }, { name: "FactSet", url: "https://factset.com/company/walmart" }] },
      { name: "Net Income", extractedValue: "$19.4 B", currentValue: "$19.4 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "EBITDA", extractedValue: "$38.2 B", currentValue: "$38.2 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "FactSet", url: "https://factset.com/company/walmart" }] },
      { name: "Total Assets", extractedValue: "$260.8 B", currentValue: "$260.8 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Shares Outstanding", extractedValue: "8.0 B", currentValue: "8.0 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 10-K", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Stock Price (Current)", extractedValue: "$129.00", currentValue: "$129.00", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      { name: "Market Capitalization", extractedValue: "$1.01 Trillion", currentValue: "$1.01 Trillion", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      { name: "Exchange Name", extractedValue: "NYSE", currentValue: "NYSE", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      { name: "Trading Status", extractedValue: "Active", currentValue: "Active", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      { name: "Stock Price (Close)", extractedValue: "$128.51", currentValue: "$128.51", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/wmt" }] },
      // Corporate Hierarchy
      { name: "Subsidiary Name", extractedValue: "Sam's Club", currentValue: "Sam's Club", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169" }] },
      { name: "Hierarchy Level", extractedValue: "1", currentValue: "1", status: "pending", qcFlag: false, sourceRefs: [{ name: "D&B", url: "https://dnb.com/company/walmart" }] },
      { name: "Coverage", extractedValue: "Global", currentValue: "Global", status: "pending", qcFlag: false, sourceRefs: [{ name: "D&B", url: "https://dnb.com/company/walmart" }] },
    ],
    sources: [
      { url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=104169", type: "API", snippet: "Walmart Inc. (CIK: 104169) filed its annual report 10-K reporting total revenue of $713.2 billion…", highlightedText: "total revenue of $713.2 billion" },
      { url: "https://walmart.com/about", type: "Website", snippet: "Walmart Inc. is an American multinational retail corporation headquartered in Bentonville, Arkansas…", highlightedText: "headquartered in Bentonville, Arkansas" },
    ],
  },
  {
    id: "REC-10051",
    ...
    confidenceScore: 74,
    sourceList: ["SEC EDGAR", "Bloomberg", "Web Crawl"],
    lastUpdated: "2026-04-01 11:30",
    existingValue: "$130.4B",
    suggestedValue: "$130.4B",
    attributes: [
      // Basic Data
      { name: "Company Name", extractedValue: "Alibaba", currentValue: "Alibaba", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }, { name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      { name: "Legal Name", extractedValue: "Alibaba Group Holding Ltd", currentValue: "Alibaba Group Holding Ltd", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Address", extractedValue: "969 West Wen Yi Rd, Hangzhou, China", currentValue: "969 West Wen Yi Rd, Hangzhou, China", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Phone Number", extractedValue: "+86 571-8502-2088", currentValue: "+86 571-8502-2088", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://alibabagroup.com/contact" }] },
      { name: "Email ID", extractedValue: "investor@alibaba-inc.com", currentValue: "investor@alibaba-inc.com", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://alibabagroup.com/contact" }] },
      { name: "Website URL", extractedValue: "alibabagroup.com", currentValue: "alibabagroup.com", status: "validated", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://alibabagroup.com" }] },
      { name: "Industry / Sector", extractedValue: "Technology / Retail", currentValue: "Technology / Retail", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      { name: "CEO / Founder", extractedValue: "Eddie Wu / Jack Ma", currentValue: "Eddie Wu / Jack Ma", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }, { name: "LinkedIn", url: "https://linkedin.com/company/alibaba" }] },
      { name: "LinkedIn URL", extractedValue: "https://linkedin.com/company/alibaba", currentValue: "https://linkedin.com/company/alibaba", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://linkedin.com/company/alibaba" }] },
      { name: "Twitter URL", extractedValue: "https://twitter.com/alibaba", currentValue: "https://twitter.com/alibaba", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://twitter.com/alibaba" }] },
      { name: "Registration Number", extractedValue: "225909 (KY)", currentValue: "225909 (KY)", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Incorporation Date", extractedValue: "June 28, 1999", currentValue: "June 28, 1999", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Company Status", extractedValue: "Active", currentValue: "Active", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Entity Type", extractedValue: "Ltd", currentValue: "Ltd", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Country", extractedValue: "Cayman Islands", currentValue: "Cayman Islands", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "LEI", extractedValue: "549300S9Y27L9Z16U829", currentValue: "549300S9Y27L9Z16U829", status: "validated", qcFlag: false, sourceRefs: [{ name: "GLEIF", url: "https://gleif.org/lei/549300S9Y27L9Z16U829" }] },
      { name: "SIC Code", extractedValue: "7389", currentValue: "7389", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "CIK", extractedValue: "1577552", currentValue: "1577552", status: "validated", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Ticker Symbol", extractedValue: "BABA", currentValue: "BABA", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      // Financial Data
      { name: "Revenue", extractedValue: "$130.4 B", currentValue: "$130.4 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 20-F", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }, { name: "FactSet", url: "https://factset.com/company/alibaba" }] },
      { name: "Net Income", extractedValue: "$11.1 B", currentValue: "$11.1 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 20-F", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "EBITDA", extractedValue: "$22.8 B", currentValue: "$22.8 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "FactSet", url: "https://factset.com/company/alibaba" }] },
      { name: "Total Assets", extractedValue: "$256.0 B", currentValue: "$256.0 B", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 20-F", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Shares Outstanding", extractedValue: "18.5 B (Ord)", currentValue: "18.5 B (Ord)", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR 20-F", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Stock Price (Current)", extractedValue: "$124.38", currentValue: "$124.38", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      { name: "Market Capitalization", extractedValue: "$230.5 Billion", currentValue: "$230.5 Billion", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      { name: "Exchange Name", extractedValue: "NYSE", currentValue: "NYSE", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      { name: "Trading Status", extractedValue: "Active", currentValue: "Active", status: "validated", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      { name: "Stock Price (Close)", extractedValue: "$121.79", currentValue: "$121.79", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/baba" }] },
      // Corporate Hierarchy
      { name: "Subsidiary Name", extractedValue: "Taobao, Tmall", currentValue: "Taobao, Tmall", status: "pending", qcFlag: false, sourceRefs: [{ name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552" }] },
      { name: "Hierarchy Level", extractedValue: "1", currentValue: "1", status: "pending", qcFlag: false, sourceRefs: [{ name: "D&B", url: "https://dnb.com/company/alibaba" }] },
      { name: "Coverage", extractedValue: "Global", currentValue: "Global", status: "pending", qcFlag: false, sourceRefs: [{ name: "D&B", url: "https://dnb.com/company/alibaba" }] },
    ],
    sources: [
      { url: "https://www.sec.gov/cgi-bin/browse-edgar?CIK=1577552", type: "API", snippet: "Alibaba Group Holding Ltd (CIK: 1577552) filed its annual report 20-F reporting total revenue of $130.4 billion…", highlightedText: "total revenue of $130.4 billion" },
      { url: "https://alibabagroup.com/about", type: "Website", snippet: "Alibaba Group's mission is to make it easy to do business anywhere. Founded in 1999, headquartered in Hangzhou, China…", highlightedText: "headquartered in Hangzhou, China" },
    ],
  },
];
