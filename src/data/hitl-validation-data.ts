...
export const sampleRecords: ValidationRecord[] = [
  {
    ...
    attributes: [
      ...
      { name: "Website", extractedValue: "https://acmecorp.com", currentValue: "https://acmecorp.com", status: "validated", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://acmecorp.com" }] },
      { name: "Industry", extractedValue: "Technology", currentValue: "Technology", status: "pending", qcFlag: false, sourceRefs: [{ name: "Bloomberg", url: "https://bloomberg.com/profile/acme" }, { name: "Reuters", url: "https://reuters.com/companies/acme" }] },
      ...
      { name: "Employee Count", extractedValue: "12,450", currentValue: "12,450", status: "pending", qcFlag: false, sourceRefs: [{ name: "LinkedIn", url: "https://linkedin.com/company/acme" }, { name: "D&B", url: "https://dnb.com/company/acme" }] },
      { name: "HQ Location", extractedValue: "San Francisco, CA", currentValue: "San Francisco, CA", status: "validated", qcFlag: false, sourceRefs: [{ name: "Company Website", url: "https://acmecorp.com/about" }, { name: "SEC EDGAR", url: "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=ACME" }] },
    ],
    sources: [
  ...
  },
  {
    ...
    attributes: [
      ...
      { name: "Website", extractedValue: "https://globaltech.io", currentValue: "https://globaltech.io", status: "pending", qcFlag: false, sourceRefs: [{ name: "Web Crawl", url: "https://globaltech.io" }] },
      { name: "Industry", extractedValue: "Financial Services", currentValue: "Financial Services", status: "pending", qcFlag: false, sourceRefs: [{ name: "Reuters", url: "https://reuters.com/companies/glbt" }, { name: "Bloomberg", url: "https://bloomberg.com/profile/glbt" }] },
      ...
      { name: "Employee Count", extractedValue: "3,200", currentValue: "3,200", status: "pending", qcFlag: false, sourceRefs: [{ name: "LinkedIn", url: "https://linkedin.com/company/globaltech" }] },
    ],
    sources: [
