                ...
                {paginatedRecords.map((rec, idx) => {
                  ...
                  return (
                    <tbody key={rec.id}>
                      ...
                      >
                        <td className="px-2 py-2 text-[11px] text-muted-foreground border-r border-border/30 text-center whitespace-nowrap">
                          {rowNum}
                        </td>
                        <td className="px-2 py-2 text-[11px] font-medium text-foreground border-r border-border/30 whitespace-nowrap">
                        ...
                        <td className="px-2 py-2 text-[11px] border-r border-border/30 whitespace-nowrap">
                          <span className="font-medium text-primary/80">{firstChange.attribute}</span>
                        </td>
                        <td className="px-2 py-2 text-[11px] text-destructive/80 border-r border-border/30 whitespace-nowrap line-through decoration-destructive/30">
                          {firstChange.oldValue}
                        </td>
                        <td className="px-2 py-2 text-[11px] text-brand font-medium border-r border-border/30 whitespace-nowrap">
